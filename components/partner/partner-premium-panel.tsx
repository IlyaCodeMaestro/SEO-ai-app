...
export default function PartnerStandardPanel({
  ...
  if (isLoading) {
    return (
      <div className="max-w-md dark:bg-[#404040] md:max-w-2xl lg:max-w-4xl mb-7 mx-auto h-full flex flex-col rounded-3xl overflow-hidden items-center justify-center">
  ...
  return (
    <div className="max-w-md dark:bg-[#404040] md:max-w-2xl lg:max-w-4xl mb-7 mx-auto h-full flex flex-col rounded-3xl overflow-hidden">
      ...
      <div
        className="bg-gradient-to-r p-6 rounded-[30px] mx-4 mb-4 text-center"
        style={{
